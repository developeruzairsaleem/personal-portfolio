...
const DESCRIPTION =
  "I ship B2B SaaS products end-to-end for founders. Next.js · TypeScript · Postgres · AWS. 4+ years, six live products, remote globally.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: TITLE,
    template: "%s · Uzair Saleem",
  },
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      >
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[60] bg-[#22c55e] text-black font-semibold px-4 py-2 rounded-md"
        >
